...
<ul class="sidebar">
  <li class="sidebar-brand"><a href="Accueil">Gestion Hospitaliere</a></li>
      <li><a href="addformRecep"><i class="fa fa-plus-square" aria-hidden="true"></i><span class="ml-1">Ajouter Receptionnsite</span></a></li>
            ...
            <div class="col-md-8">
              <div class="card">
                ...
                <!-- modelAttribute formulaire a besion d'un model le controller va creer se model action c'est notre route ajouterDoc -->
                  <form:form modelAttribute="Receptionniste" method="POST" action="editsaveRecep">
