            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Les informations d'un patient</p>
                </div>
                <div class="card-body">
                <!-- modelAttribute formulaire a besion d'un model le controller va creer se model action c'est notre route ajouterDoc -->
                  <form:form modelAttribute="Patient" method="POST" action="AjouterPat">
                    <div class="row">
                      <div class="col-md-5">
	 			 ...
	 			 <form:option value="${doc.id}"> ${doc.nom}  </form:option>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <button type="submit" value="submit" class="btn btn-primary pull-right" >Ajouter Patient</button>
