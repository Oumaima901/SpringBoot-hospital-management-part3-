...
<ul class="sidebar">
  <li class="sidebar-brand"><a href="welcome">Gestion Hospitaliere</a></li>
     ...
     <li><a href="AffichageListeRecep"> <i class="fa fa-hand-o-left" aria-hidden="true"></i><span class="ml-1">retourne </span></a></li>
      </ul>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Ajouter un Receptionnsite</h4>
                  <p class="card-category">Les informations du Receptionnsite</p>
                </div>
                <div class="card-body">
                <!-- modelAttribute formulaire a besion d'un model le controller va creer se model action c'est notre route ajouterDoc -->
                  <form:form modelAttribute="Receptionniste" method="POST" action="AjouterRecep">
                    <div class="row">
                      <div class="col-md-5">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <button type="submit" value="submit" class="btn btn-primary pull-right" >Ajouter </button>
